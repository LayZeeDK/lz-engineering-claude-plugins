...
|------|----|----|--------|---------|
| natural sweep prompt | lz-refactor auto-invocation | SKILL.md `description` (241c1fb) | WIRED | 18/18 e2e + gr4 3/3 + nx p8 3/3 (both post-revert, HEAD); description in HEAD, validate PASS |
...
3. **[Resolved 2026-07-14]** nx sweep auto-trigger now directly measured on HEAD post-revert (quick 260714-vmy: p8 with_skill apply k=3 -> 3/3), closing the prior "inferred, not re-measured" nuance. No regression from 9832c74.
