...
**Status:** complete
**Commit:** 09e5c89 (SKILL.md only -- preserves the D-16 pre-edit baseline: instruments in ba2af4e, skill edited after)
...
Two research-informed text edits to `plugins/lz-tdd/skills/lz-refactor/SKILL.md`, building on the committed quick-task form (241c1fb), no catalog/smells/principles re-authoring, seam preserved (D-01):
