...
|-----------|----------|-----------|-------------|------------|--------|
| T-06-01 | Information Disclosure | committed files (SKILL.md, references/*, checker) | mitigate | Work email absent; public contact larsbrinknielsen@gmail.com only. VERIFIED by allowlist-inversion: enumerating every email-shaped token over the created tree and subtracting the approved public gmail (larsbrinknielsen@gmail.com) leaves an empty remainder -- the approved gmail is the only email-shaped token present, no other email of any kind. | closed |
