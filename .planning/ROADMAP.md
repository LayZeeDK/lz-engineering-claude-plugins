...
### Next milestone (post-0.0.1)

Not yet defined -- start with `/gsd-new-milestone`. Candidate directions carried
from the previous REQUIREMENTS "Later" section: additional TDD skills under `lz-tdd`
(NEXT-01), additional plugins in the marketplace (NEXT-02), npm packaging /
distribution (NEXT-03), and multi-language example sets beyond TypeScript (NEXT-04).
...
---
*Roadmap created: 2026-07-02 | lz-tdd@0.0.1 milestone completed: 2026-07-04*
